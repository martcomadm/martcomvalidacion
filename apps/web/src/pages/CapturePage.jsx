...
const EJECUTIVOS = [
  'ADRIANA RANGEL', 'ARTURO GARCIA', 'AXEL YAÑEZ', 'BLANCA SEGUNDO', 'CARLOS RUIZ',
  'CLAUDIA RAMIREZ', 'DIETER MARTINEZ', 'ELIZABETH AGUILERA', 'FATIMA OLVERA',
  'ISELA GALICIA', 'JOSE LARA', 'JOSE LUIS MARTINEZ', 'JOSSELINE GALICIA',
  'JOZIC MARTINEZ', 'JULIETA GALLEGOS', 'LIZETTE MORALES', 'MONSERRAT OLVERA',
...
const TIPOS_INGRESO = ['PREDICTIVO', 'RECUPERACIÓN', 'PROVEEDOR', 'REFERIDO', 'NUEVA'];

const CHATS = [
  'CRM', 'PREDICTIVO', 'CHAT 01', 'CHAT 02', 'CHAT 03', 'CHAT 04',
  'CHAT 05', 'CHAT 06', 'CHAT 07', 'CHAT 09', 'CHAT 11', 'CHAT B'
];
